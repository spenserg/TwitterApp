 ...
 */
    ...
    Configure::write('oauth_token', array_key_exists('oauth_token', $request) ? $response['oauth_token'] : null);
    Configure::write('oauth_token_secret', array_key_exists('oauth_token_secret', $request) ? $response['oauth_token_secret'] : null);
