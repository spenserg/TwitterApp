...
/*--- Begin Proxy methods for Utility/Twitter ---*/
	...
	public function setupApp($Model, $consumerKey = null, $consumerSecret = null) {
	  if ($consumerKey == null){ $consumer_key = Configure::read('Twitter.key'); }
    if ($consumerSecret == null){ $consumerSecret = Configure::read('Twitter.secret'); }
